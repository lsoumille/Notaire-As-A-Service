...
import { Loader2, ExternalLink, Calendar, AlertCircle } from 'lucide-react';
          ...
          <div className="bg-white/5 border border-brand-accent/20 rounded-2xl p-6 mb-8">
            <div className="flex items-start gap-3">
              ...
              <div className="text-white/80 text-xs leading-relaxed">
                ...
                <p>Cet outil est purement informatif et ne constitue pas un conseil. Les simulations et analyses proposées sont indicatives. Consultez toujours votre notaire et votre conseiller en gestion de patrimoine pour toute décision.</p>
              </div>
            </div>
          </div>
